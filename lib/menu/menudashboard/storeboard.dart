...
class StoreBoard extends StatefulWidget {
  const StoreBoard({Key? key}) : super(key: key);

  @override
  _StoreBoardState createState() => _StoreBoardState();
}

class _StoreBoardState
    extends State<StoreBoard> {
